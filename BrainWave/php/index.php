...
<body>
    <header class="header-area">
        <div class="nav">
            <nav class="site-navbar">
                <a href="../php/home.php" class="site-logo"><img src="../img/logo-transp.png" alt=""></a>
                <ul>
                    <li class="item"><a href="../php/index.php">Psicólogos</a></li>
                    <li class="item"><a href="../php/2Recursos.php">recursos</a></li>
                    <li class="item"><a href="../php/aboutus.php">Nosotros</a></li>
                    <li class="button"><a href="../php/login.php">LOGIN</a></li>
                </ul>
    ...
    <section id="team" class="team">
        <!-- PHP loop to generate team members -->
        <?php
        if (isset($_SESSION['team']) && is_array($_SESSION['team'])) {
        ...
        <div class="footer">
            <div class="contact-info">
                ...
                <div style="direction: rtl;">
                    <div class="address">
                        <img src="../img/location.png" alt="" width=20>
                ...
                <div class="right">
                    <div class="info">
                        ...
                        <div class="email">
                            ...
                            <a href="../../../P.I.2-main/BrainWave/php/dashboard.php" class="modal-cita">PEDIR CITA</a>
                        </div>
                    </div>
                </div>
            </div>
